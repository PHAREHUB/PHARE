...
namespace PHARE
{
/**@brief a FieldRefiner is an object that is used to get the value of a field at a fine AMR index
 * from coarse data
 *
...
{
public:
    FieldRefiner(std::array<QtyCentering, dimension> const& centering,
     ...
     * - we just have to know which one to use, depending on where the fineIndex is in the coarse
     * cell
     */
