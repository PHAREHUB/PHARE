#ifndef PHARE_ELECTRIC_FIELD_REFINER2_HPP
#define PHARE_ELECTRIC_FIELD_REFINER2_HPP
...
class ElectricFieldRefiner2
{
public:
    ElectricFieldRefiner2(std::array<core::QtyCentering, dimension> const& centering,
