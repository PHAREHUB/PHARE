...
namespace amr
{
    ...
    class ParticlesData : public SAMRAI::hier::PatchData
    {
        ...
        // without access to interp_order we cannot do this:
        // static constexpr int ghostSafeMapLayer = ghostWidthForParticles<interp_order>() + 1;
        // so we do that :
        static constexpr int ghostSafeMapLayer = 4;
        // which results in mapping more cells than strictly necessary but should never crash
