...
namespace amr
{
    ...
    public:
        ...
        {
            PHARE_LOG_SCOPE(5, "ParticlesData::copy");
        ...
        {
            PHARE_LOG_SCOPE(5, "ParticlesData::copy with overlap");
        ...
        {
            PHARE_LOG_SCOPE(5, "ParticleData::packStream");
        ...
        void unpackStream(SAMRAI::tbox::MessageStream& stream,
                          SAMRAI::hier::BoxOverlap const& overlap) override
        {
            PHARE_LOG_SCOPE(5, "ParticleData::unpackStream");
    ...
    private:
        ...
        void copy_(SAMRAI::hier::Box const& overlapBox, ParticlesData const& sourceData)
        {
            ...
            PHARE_LOG_START(5, "ParticleData::copy_ DomainToDomain");
            ...
            PHARE_LOG_START(5, "ParticlesData::copy_ DomainToGhosts");
            ...
            PHARE_LOG_STOP(5, "ParticlesData::copy_ DomainToGhosts");
        }
                   ...
                   SAMRAI::hier::Transformation const& transformation)
        {
            ...
            PHARE_LOG_START(5, "ParticleData::copy_ (transform)");
            ...
            PHARE_LOG_START(5, "DomainToDomain (transform)");
            if (!destBox.empty())
            {
            ...
            PHARE_LOG_STOP(5, "DomainToDomain (transform)");



            PHARE_LOG_START(5, "DomainToGhosts (transform)");
            ...
            PHARE_LOG_STOP(5, "DomainToGhosts (transform)");
            PHARE_LOG_STOP(5, "ParticleData::copy_ (transform)");
        }
        ...
        {
            PHARE_LOG_SCOPE(5, "ParticleData::countNumberParticlesIn_");
            std::size_t numberParticles = 0;
        ...
        {
            PHARE_LOG_SCOPE(5, "ParticleData::pack_");
