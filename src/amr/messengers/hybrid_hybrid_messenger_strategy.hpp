...
namespace amr
{
    ...
    public:
        ...
        void fillIonPopBorders(IonsT& ions, level_t& level, double const fillTime) override
        {
            ...
            {
                for (auto patch : resourcesManager_->enumerate(level, ions, tmpVecField0_,
                                                               tmpField0_, tmpField1_))
                {
    ...
    private:
        ...
        using InitRefinerPool  = RefinerPool<rm_t, HybridModel, RefinerType::InitField>;
        using GhostRefinerPool = RefinerPool<rm_t, HybridModel, RefinerType::GhostField>;
        using InitDomPartRefinerPool
            = RefinerPool<rm_t, HybridModel, RefinerType::InitInteriorPart>;
        using LevelBorderFieldRefinerPool
            = RefinerPool<rm_t, HybridModel, RefinerType::LevelBorderField>;
        using DomainGhostPartRefinerPool
            = RefinerPool<rm_t, HybridModel, RefinerType::ExteriorGhostParticles>;
        using PatchGhostRefinerPool = RefinerPool<rm_t, HybridModel, RefinerType::PatchGhostField>;
        ...
        using IonPopBorderSumRefiner
            = Refiner<rm_t, HybridModel, RefinerType::PatchIonPopBorderSum>;
        ...
        //! MultiFieldBorderOpTransactionFactory)
        Refiner<rm_t, HybridModel, RefinerType::PatchIonPopBorderMax> ionPopBorderMaxRefiners_;
        ...
        RefinerPool<rm_t, HybridModel, LGRefT> lvlGhostPartOldRefiners_{resourcesManager_};
        RefinerPool<rm_t, HybridModel, LGRefT> lvlGhostPartNewRefiners_{resourcesManager_};
