...
namespace amr
{
    ...
    public:
                       ...
                       double const initDataTime) override
        {
            ...
            PHARE_LOG_START(5, "hybhybmessengerStrat::initLevel : interior part fill schedule");
            domainParticlesRefiners_.fill(levelNumber, initDataTime);
            PHARE_LOG_STOP(5, "hybhybmessengerStrat::initLevel : interior part fill schedule");
            ...
            PHARE_LOG_START(5, "hybhybmessengerStrat::initLevel : patch ghost part fill schedule");
            patchGhostPartRefiners_.fill(levelNumber, initDataTime);
            PHARE_LOG_STOP(5, "hybhybmessengerStrat::initLevel : patch ghost part fill schedule");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::fillElectricGhosts");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::fillCurrentGhosts");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::fillIonGhostParticles");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::fillIonMomentGhosts");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::firstStep");
            ...
            if (levelNumber != 0)
            {
                PHARE_LOG_START(5, "HybridHybridMessengerStrategy::firstStep.fill");
                lvlGhostPartNewRefiners_.fill(levelNumber, currentTime);
                PHARE_LOG_STOP(5, "HybridHybridMessengerStrategy::firstStep.fill");
        ...
        void lastStep(IPhysicalModel& model, SAMRAI::hier::PatchLevel& level) override
        {
            ...
            {
                PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::lastStep");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::prepareStep");
        ...
        {
            PHARE_LOG_SCOPE(5, "HybridHybridMessengerStrategy::synchronize");
