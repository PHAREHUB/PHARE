...
#include "core/numerics/ion_updater/openacc/ion_updater.h"

#include <iomanip>

namespace PHARE::solver::openacc
{
// -----------------------------------------------------------------------------
...
private:
    ...
    PHARE::core::openacc::IonUpdater<Ions, Electromag, GridLayout> ionUpdater_;
