...
#include "core/numerics/ion_updater/multithread/ion_updater.h"

#include <iomanip>

namespace PHARE::solver::multithread
{
// -----------------------------------------------------------------------------
...
private:
    ...
    PHARE::core::multithread::IonUpdater<Ions, Electromag, GridLayout> ionUpdater_;
