 ...
 * nature of the models at the fine and coarse levels in between which the messengers take place.
 *
 * However, for each of these operations several quantities are concerned and their nature depends
 * on the nature of the models at the fine and coarse levels. For instance, messengers of data
 ...
 *
 * Therefore, specializing the IMessenger interface with a concrete implementation is required for
...
public:
     ...
     * the names of all data involved in this messenger that comes from the coarse level.
     *
     * @param fromFinerInfo is an abstract object of which concrete derived structure encapsulates
     * the names of all data involved in this messenger that comes from the fine level.
     *
     ...
     * cycle because some concrete IMessenger object may need to perform some operations at this
     * time.
     *
     ...
     * substepping cycle. Concrete IMessenger objects may need to perform operations at this step.
     *
     * @param model
     */
