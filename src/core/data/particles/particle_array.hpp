...
public:
    ...
    {
        PHARE_LOG_SCOPE(5, "ParticleArray::export_particles");
    ...
    {
        PHARE_LOG_SCOPE(5, "ParticleArray::export_particles (Fn)");
    ...
    {
        PHARE_LOG_SCOPE(5, "ParticleArray::export_particles (box, vector, Fn)");
        cellMap_.export_to(box, particles_.data(), dest, std::forward<Fn>(fn));
    }
    ...
    {
        PHARE_LOG_SCOPE(5, "ParticleArray::export_particles (Fn,vector)");
