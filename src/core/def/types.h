...
#ifndef PHARE_CORE_DEF_TYPES_H
#define PHARE_CORE_DEF_TYPES_H

#include "core/def.hpp"
#include "core/def/detail/umpire.h"
#include "core/def/detail/raja.h" // checks for umpire to know if gpu

namespace PHARE
{
struct CompileOptions
{
    static constexpr bool WithUmpire = false; // PHARE_HAVE_UMPIRE;
    static constexpr bool WithRAJA   = false; // PHARE_HAVE_RAJA;
};
} // namespace PHARE
