#
# parsing scorep.score files to print by functions taking most time
#
# use like:
#  python3 tools/python3/scorep.py print_score_p_score -f scorep/scorep.score
#
...
class ScorePScore:
    ...
    def parsed_user_lines(self, worst_first):
        ...
        return sorted(lines) if worst_first else lines
