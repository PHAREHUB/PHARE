...
def _intersect_coarser_1d(clazz, coarseDomain, coarsePatchGhost, fineLevelGhost):
    assert all(
        [isinstance(x, Patch) for x in [coarseDomain, coarsePatchGhost, fineLevelGhost]]
    )

    overlaps = _calculate_coarser_1d(
        clazz, coarseDomain, coarsePatchGhost, fineLevelGhost, "particles"
    )
...
def _calculate_coarser_1d(
    clazz, coarseDomain, coarsePatchGhost, fineLevelGhost, dataset_key
):
