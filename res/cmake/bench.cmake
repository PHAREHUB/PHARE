...
#
#   add_phare_benchmark(project file directory)
#    create $target ${project}_${file}
#    execute $target in $directory, with mpirun when -DtestMPI=ON
#
...
if (bench)
  ...
  function(add_phare_benchmark_ target file directory)
  ...
  endfunction(add_phare_benchmark_)

  function(add_phare_benchmark project file directory)
    add_phare_benchmark_(${project}_${file} ${file}.cpp ${directory})
    target_link_libraries(${project}_${file} PUBLIC ${GBENCH_LIBS} phare_simulator)
  endfunction(add_phare_benchmark)
