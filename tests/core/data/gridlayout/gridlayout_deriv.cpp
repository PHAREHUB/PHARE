...
//     {
//         Point<double, 1> point = this->layout.fieldNodeCoordinates(this->By, ix);
...
//     {
//         Point<double, 1> point = this->layout.fieldNodeCoordinates(this->Ez, ix);
...
// using layoutImpls2D
//     = ::testing::Types<GridLayoutImplYee<2, 1>, GridLayoutImplYee<2, 2>, GridLayoutImplYee<2,
//     3>>;
...
//         {
//             Point<double, 2> point = this->layout.fieldNodeCoordinates(this->By, ix, iy);
//             this->By(ix, iy)
...
//         for (auto iy = 0u; iy <= gei_p_Y; ++iy)
//         {
//             Point<double, 2> point = this->layout.fieldNodeCoordinates(this->Ez, ix, iy);
//             this->Ez(ix, iy)
//                 = std::cos(2 * M_PI / 5. * point[0]) * std::sin(2 * M_PI / 6. * point[1]);
//         }
//     }
...
//         for (auto iy = 0u; iy <= gei_p_Y; ++iy)
//         {
//             auto point = this->layout.fieldNodeCoordinates(this->Ez, ix, iy);
//             this->Ez(ix, iy)
//                 = std::cos(2 * M_PI / 5. * point[0]) * std::sin(2 * M_PI / 6. * point[1]);
//         }
//     }
...
// using layoutImpls3D
//     = ::testing::Types<GridLayoutImplYee<3, 1>, GridLayoutImplYee<3, 2>, GridLayoutImplYee<3,
//     3>>;
...
//             {
//                 auto point           = this->layout.fieldNodeCoordinates(this->By, ix, iy, iz);
...
//             for (auto iz = 0u; iz <= gei_d_Z; ++iz)
//             {
//                 auto point           = this->layout.fieldNodeCoordinates(this->Ez, ix, iy, iz);
