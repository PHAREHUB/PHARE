...
protected:
    ...
    Field<NdArray_t<1>, typename HybridQuantity::Scalar> bx1d_;
    Field<NdArray_t<1>, typename HybridQuantity::Scalar> by1d_;
    Field<NdArray_t<1>, typename HybridQuantity::Scalar> bz1d_;

    Field<NdArray_t<2>, typename HybridQuantity::Scalar> bx2d_;
    Field<NdArray_t<2>, typename HybridQuantity::Scalar> by2d_;
    Field<NdArray_t<2>, typename HybridQuantity::Scalar> bz2d_;

    Field<NdArray_t<3>, typename HybridQuantity::Scalar> bx3d_;
    Field<NdArray_t<3>, typename HybridQuantity::Scalar> by3d_;
    Field<NdArray_t<3>, typename HybridQuantity::Scalar> bz3d_;

    VecField<NdArray_t<1>, HybridQuantity> B1D_;
    VecField<NdArray_t<2>, HybridQuantity> B2D_;
    VecField<NdArray_t<3>, HybridQuantity> B3D_;
};
...
TEST(aVecField, dataCanBeCopiedIntoAnother)
{
    ...
    Field<NdArray_t<3>, Scalar> bx1{"B1_bx1", Scalar::Bx, 2u, 3u, 4u};
    Field<NdArray_t<3>, Scalar> by1{"B1_by1", Scalar::By, 2u, 3u, 4u};
    Field<NdArray_t<3>, Scalar> bz1{"B1_bz1", Scalar::Bz, 2u, 3u, 4u};
    VecField<NdArray_t<3>, HybridQuantity> B1{"B1", HybridQuantity::Vector::B};
    ...
    Field<NdArray_t<3>, Scalar> bx2{"B2_bx2", Scalar::Bx, 2u, 3u, 4u};
    Field<NdArray_t<3>, Scalar> by2{"B2_by2", Scalar::By, 2u, 3u, 4u};
    Field<NdArray_t<3>, Scalar> bz2{"B2_bz2", Scalar::Bz, 2u, 3u, 4u};
    VecField<NdArray_t<3>, HybridQuantity> B2{"B2", HybridQuantity::Vector::B};
