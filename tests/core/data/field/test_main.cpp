...
public:
    GenericField1D()
        : f{"test", PHARE::HybridQuantity::rho, nx}
    {
    }

protected:
    const int nx = 10;
    Field<NdArrayImpl, PHARE::HybridQuantity> f;
};
...
public:
    GenericField2D()
        : f{"test", PHARE::HybridQuantity::rho, nx, ny}
    {
    }
...
public:
    GenericField3D()
        : f{"test", PHARE::HybridQuantity::rho, nx, ny, nz}
    {
    }
...
{
    EXPECT_EQ(PHARE::HybridQuantity::rho, this->f.physicalQuantity());
}
