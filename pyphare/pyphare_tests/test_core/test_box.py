...
class BoxTesT(unittest.TestCase):
    ...
    @data(
          ...
          (Box2D(10, 29), Box2D(10, 25), [  # remove down left
            Box([26, 10], [29, 29]),        # right
            Box([10, 26], [25, 29]),        # up
          ]),

          (Box2D(10, 29), Box2D(20, 29), [ # remove up right
            Box([10, 10], [19, 29]),       # left
            Box([20, 10], [29, 19])        # down
          ]),

          (Box2D(10, 29), Box2D(15, 25), [ # remove middle
          ...
          (Box2D(10, 29), Box2D(20, 25), [ # remove middle
              Box([10, 10], [19, 29]), # left
              Box([26, 10], [29, 29]), # right
          ...
          (Box2D(10, 29), Box([15, 10], [15, 25]), [ # enters one side
              Box([10, 10], [14, 29]), # left
              Box([16, 10], [29, 29]), # right
              Box([15, 26], [15, 29])  # up
           ]),

          (Box3D(10, 29), Box3D(10, 15), [ # remove down left back
              Box([16, 10, 10], [29, 29, 29]), # right
              Box([10, 16, 10], [15, 29, 29]), # up
              Box([10, 10, 16], [15, 15, 29]), # front
           ]),

          (Box3D(10, 29), Box3D(20, 25), [ # remove middle
           ...
           (Box3D(10, 29), Box([20,10,20], [20, 29, 20]), [ # remove middle Y block
              Box([10, 10, 10], [19, 29, 29]), # left
          ...
          (Box3D(10, 29), Box([10,10,10], [10, 29, 29]), [ # remove left
              Box([11, 10, 10], [29, 29, 29]), # right
           ]),

          (Box3D(10, 29), Box([29,10,10], [29, 29, 29]), [ # remove right
              Box([10, 10, 10], [28, 29, 29]), # left
           ]),

          (Box3D(10, 29), Box([10,10,10], [29, 29, 10]), [ # remove back
              Box([10, 10, 11], [29, 29, 29]), # front
           ]),

          (Box3D(10, 29), Box([10,10,29], [29, 29, 29]), [ # remove front
