...
class Simulation(object):
    ...
    **Adaptive Mesh Refinement (AMR) parameters:**
        ...
        * **refined_particle_nbr** (``int``), number of refined particle per coarse particle. Omit it for a run with no hybrid model.
        * **nesting_buffer** (``int``), default=0 minimum gap in coarse cells from the border of a level and any refined patch border
